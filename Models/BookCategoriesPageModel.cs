...
namespace Turc_Ana_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Turc_Ana_Lab2Context context,
                                               Book book)
        {
        ...
        public void UpdateBookCategories(Turc_Ana_Lab2Context context,
